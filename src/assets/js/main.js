$(document).ready(function () {
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(event.strftime('<span class="cdown day" style="color: #ffffff">%-D <p style="color: #ffffff">Días</p></span> <span class="cdown hour" style="color: #ffffff">%-H <p style="color: #ffffff">Hora</p></span> <span class="cdown minutes" style="color: #ffffff">%M <p style="color: #ffffff">Min</p></span class="cdown second"> <span style="color: #ffffff">%S <p style="color: #ffffff">Seg</p></span>'));
        });
    });
